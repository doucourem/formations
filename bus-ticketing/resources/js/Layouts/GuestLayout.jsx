...
const menus = {
  management: [
    ...
    { title: "Transport", items: [{ text: "Transport", icon: <DirectionsBusIcon />, children: [{ text: "Bus", route: route("buses.index") }, { text: "Chauffeurs", route: route("drivers.index") }, { text: "Routes", route: route("busroutes.index") }, { text: "Voyages", route: route("trips.index") }] }] },
    { title: "Gestion commerciale", items: [{ text: "Billets vendus", icon: <ConfirmationNumberIcon />, route: route("ticket.index") }, { text: "Colis", icon: <LocalShippingIcon />, route: route("parcels.index") }, { text: "Transfers", icon: <SyncAltIcon />, route: route("transfers.index") }] },
